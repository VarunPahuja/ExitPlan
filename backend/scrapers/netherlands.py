"""
Netherlands immigration policy scraper — Scrapy spider.

Source: ind.nl (Immigratie- en Naturalisatiedienst / Immigration and Naturalisation
Service) — the official Dutch immigration authority. Covers HSM permit, EU Blue Card,
and permanent residence. Plain HTML, no Cloudflare blocking.
"""
...
_URL_VISA_MAP = {
    ...
    "european-blue-card": "EU Blue Card",
